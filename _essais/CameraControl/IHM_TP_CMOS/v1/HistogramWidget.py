...
class Histogram_Widget(QWidget):
    ...
    def update(self, data):
        ...
        if self.FrameOrLists == "frame":
            ...
            barGraph = pg.BarGraphItem(x = self.abscissas, height = data, width = 1, brush ='blue')
        ...
        # Plot method for the list of lists
            ...
            for i, datum in enumerate(data):
                ...
                barGraph = pg.BarGraphItem(x = self.abscissas[firstIndex:lastIndex], height = histogram[firstIndex:lastIndex], width = 0.6, brush = color, name = "Pixel n°" + str(i))
                self.plotChart.addItem(barGraph)
