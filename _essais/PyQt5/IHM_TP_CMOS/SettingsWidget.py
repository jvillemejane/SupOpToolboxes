...
class Settings_Widget(QWidget):
    ...
    def __init__(self):
        ...
        self.AOISettingX = Setting_Widget(settingLabel = " AOI X ")
        self.AOISettingY = Setting_Widget(settingLabel = " AOI Y ")
        self.AOISettingWidth = Setting_Widget(settingLabel = " AOI Width ")
        self.AOISettingHeight = Setting_Widget(settingLabel = " AOI Height ")
        self.AOIRefreshButton = QPushButton("Refresh")
        ...
        layout.addWidget(self.AOIRefreshButton)
...
class Setting_Widget(QWidget):
    def __init__(self, settingLabel, minimumValue = 0, maximumValue = 100, initialisationValue = 50):
        ...
        self.labelValue = QLabel(self.selectionLabel +": ")
