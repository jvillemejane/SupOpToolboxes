...
class Chart_Widget(QWidget):
    ...
    def __init__(self, measurementInterval = 100):
        ...
        self.endStopTime = 0
        self.startTime = 0
        self.measurementInterval = 100 # ms
        ...
        self.saveBt.clicked.connect(self.saveFunction)
    ...
    def addOrdinatesPoints(self, ordinates):
        """
    ...
    def minimumOrdinates(self):
        ...
        """
        minimum = min(min(list[-50:]) for list in [self.ordinateAxis1, self.ordinateAxis2, self.ordinateAxis3, self.ordinateAxis4])
        if minimum >= 0.5:
            return minimum - 0.5
        return minimum
    ...
    def maximumOrdinates(self):
        ...
        """
        maximum = max(max(list[-50:]) for list in [self.ordinateAxis1, self.ordinateAxis2, self.ordinateAxis3, self.ordinateAxis4])
        if maximum <=259.5:
            return maximum + 0.5
        return maximum
    ...
    def saveFunction(self):
        ...
        with open("IntensitiesOverTime.txt", 'w') as file:
